...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_MainLanguage = { "MainLanguage", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChangeLanguageDeveloperSettings, MainLanguage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_MainLanguage_MetaData), Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_MainLanguage_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_SupportLanguage = { "SupportLanguage", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChangeLanguageDeveloperSettings, SupportLanguage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_SupportLanguage_MetaData), Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_SupportLanguage_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_ChangeLanguageComboKeys_Inner = { "ChangeLanguageComboKeys", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(0, nullptr) }; // 46000949
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_ChangeLanguageComboKeys = { "ChangeLanguageComboKeys", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChangeLanguageDeveloperSettings, ChangeLanguageComboKeys), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_ChangeLanguageComboKeys_MetaData), Z_Construct_UClass_UChangeLanguageDeveloperSettings_Statics::NewProp_ChangeLanguageComboKeys_MetaData) }; // 46000949
	...
	struct Z_CompiledInDeferFile_FID_PluginPackage_UE53_ChangeLanguage_HostProject_Plugins_ChangeLanguage_Source_ChangeLanguage_Public_ChangeLanguage_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginPackage_UE53_ChangeLanguage_HostProject_Plugins_ChangeLanguage_Source_ChangeLanguage_Public_ChangeLanguage_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChangeLanguageDeveloperSettings, UChangeLanguageDeveloperSettings::StaticClass, TEXT("UChangeLanguageDeveloperSettings"), &Z_Registration_Info_UClass_UChangeLanguageDeveloperSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChangeLanguageDeveloperSettings), 4170494447U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginPackage_UE53_ChangeLanguage_HostProject_Plugins_ChangeLanguage_Source_ChangeLanguage_Public_ChangeLanguage_h_382511941(TEXT("/Script/ChangeLanguage"),
		Z_CompiledInDeferFile_FID_PluginPackage_UE53_ChangeLanguage_HostProject_Plugins_ChangeLanguage_Source_ChangeLanguage_Public_ChangeLanguage_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PluginPackage_UE53_ChangeLanguage_HostProject_Plugins_ChangeLanguage_Source_ChangeLanguage_Public_ChangeLanguage_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
