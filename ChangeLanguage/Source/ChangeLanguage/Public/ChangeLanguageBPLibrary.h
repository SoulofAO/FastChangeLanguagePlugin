...
#include "ChangeLanguageBPLibrary.generated.h"
...
UCLASS()
class UChangeLanguageBPLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintCallable)
	static void ChangeEditorLanguage(FString LanguageName);

	UFUNCTION(BlueprintCallable)
	static FString GetEditorLanguage();
};
